...
Metric Score:<br>
R² Score: 0.9726<br>
MAE (Mean Absolute Error): 2186.90<br>
...
Strong correlation between price and total order value.<br>

📉 Visual Output Example
The scatter plot below shows the comparison between actual vs predicted sales.<br>
The red dashed line represents perfect predictions.<br>
Points close to this line indicate a high-performing model.<br>
